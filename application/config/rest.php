...
|
*/
$config['rest_auth'] = 'basic'; // Menyalakan auth untuk login
...
|
*/
$config['auth_source'] = ''; //ldap kosongin saja jika pakai rest_auth = basic
...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234','katon' => '21031997'];
...
|
*/
$config['rest_enable_keys'] = TRUE; // Aktifkan API key nya
...
|
*/
$config['rest_key_name'] = 'mahasiswa-api-key';
...
*/
$config['rest_enable_limits'] = TRUE; // Aktifkan limit
